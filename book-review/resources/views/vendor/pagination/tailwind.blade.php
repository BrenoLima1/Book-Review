@if ($paginator->hasPages())
    <nav role="navigation" aria-label="{{ __('Pagination Navigation') }}" class="flex flex-col items-center space-y-2">
        {{-- Desktop/Default: Numbers and arrows --}}
        <div>
                        ...
                        @foreach ($element as $page => $url)
                            ...
                            <span aria-current="page">
                                <span class="relative inline-flex items-center px-4 py-2 -ml-px text-sm font-bold
                                            text-white bg-indigo-600 border border-indigo-600 cursor-default leading-5
        ...
        {{-- Text "Showing ... results" BELOW the numbers --}}
        <div>
        ...
        {{-- Mobile simple prev/next below (optional) --}}
